...
const AadharOtpEnterScreen = ({navigation, route}) => {
  ...
  const handleSubmit = values => {
    // calling Backend
    navigation.navigate(routeName.SELFIE_SCREEN);
    navigation.reset({
      index: 0,
      routes: [{name: routeName.SELFIE_SCREEN}],
    });
  };
  ...
  return (
    <AppScreen>
      <View style={styles.screen}>
        ...
        <AppText style={styles.heading}>Aadhar OTP Verification</AppText>
        <View style={styles.headingUnder}></View>

        <AppText style={styles.desc}>
          Enter OTP sent to linked mobile number {'\n'}+91 XXXXXX8768
        </AppText>
...
export default AadharOtpEnterScreen;

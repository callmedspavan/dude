...
const EmailOtpEnterScreen = ({navigation, route}) => {
  ...
  const handleSubmit = values => {
    // calling Backend
    navigation.navigate(routeName.PERMISSIONS_SCREEN);
    navigation.reset({
      index: 0,
      routes: [{name: routeName.PERMISSIONS_SCREEN}],
    });
  };
  ...
  return (
    <AppScreen>
      <View style={styles.screen}>
        ...
        <AppText style={styles.heading}>Email OTP Verification</AppText>
...
export default EmailOtpEnterScreen;
